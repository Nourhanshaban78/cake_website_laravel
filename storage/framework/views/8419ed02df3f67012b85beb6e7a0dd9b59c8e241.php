...
<body>
            ...
            <div class="container">
                ...
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    <?php if(auth()->guard()->check()): ?>
                      <li>  <a href="<?php echo e(url('/dashboard')); ?>" class="text-sm text-gray-700 underline">Logout</a></li>
                    <?php else: ?>
                       <li> <a href="<?php echo e(route('login')); ?>" class="text-sm text-gray-700 underline">Log in</a></li>
    ...
    <?php echo $__env->make('user.food', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

   
    <!-- Class Section Begin -->
   <?php echo $__env->make('user.class_section', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

    <!-- Team Section Begin -->
    <?php echo $__env->make('user.chef', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!-- Team Section End -->
...
</html><?php /**PATH E:\totorial\cake\resources\views/user/home.blade.php ENDPATH**/ ?>