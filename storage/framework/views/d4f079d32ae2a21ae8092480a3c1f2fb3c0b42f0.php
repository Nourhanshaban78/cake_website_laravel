                           ...
                           <div class="checkout__order">
                                ...
                                <ul class="checkout__total__products">
                                    <li> <input type="text" name="order_name[]"
                                     value="<?php echo e($data->name); ?>" hidden=""  > <?php echo e($data->name); ?> 
                                     <span>             
                                        
                                     <input type="text" name="order_price[]"
                                     value="$<?php echo e($data->price * $data->quantity); ?>" hidden="">
                                     
                                     $<?php echo e($data->price * $data->quantity); ?></span></li>
                                    
                                </ul>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <ul class="checkout__total__all">
                                    <li>Subtotal <span>$<?php echo e($data->price * $data->quantity); ?></span></li>
                                    <li>Total <span>$<?php echo e($data->price * $data->quantity); ?></span></li>
                                </ul>
...
</html><?php /**PATH E:\totorial\cake\resources\views/user/check.blade.php ENDPATH**/ ?>