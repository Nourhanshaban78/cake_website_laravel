                                ...
                                <tr>
                                    <td class="product__cart__item">
                                        <div class="product__cart__item__pic">
                                            <img style="width:100px; hight:100px;" src="menuimage/<?php echo e($data->image); ?>" alt="">
                                        </div>
                                    ...
                                    <td class="cart__price"> <span><?php echo e($data->price * $data->quantity); ?>$</span>  </td>

                                    <!-- <td style="padding:10px;"><a class="btn btn-dark" href="<?php echo e(url('deleted',$data->id)); ?>"
                                     onclick="return confirm('Are you sure to delete the message')">Remove</a></td> -->
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="continue__btn">
                                <a href="<?php echo e(url('/wisslist')); ?>">Continue Shopping</a>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="continue__btn update__btn">
                                <a href="<?php echo e(url('checkout',Auth::user()->id)); ?>"><i class="fa fa-spinner"></i> Check Out</a>
                            </div>
                        </div>
                    </div>
                </div>
...
</html><?php /**PATH E:\totorial\cake\resources\views/user/shop_cart.blade.php ENDPATH**/ ?>