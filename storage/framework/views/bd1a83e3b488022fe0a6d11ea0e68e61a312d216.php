...
<html lang="en">
  ...
  <?php echo $__env->make('admin.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
     ...
     <div  class="container"  style="padding-top:100px;" >
         ...
         <form action="<?php echo e(url('/editmenu',$data->id)); ?>" method="post" enctype="multipart/form-data">
           ...
           <?php echo csrf_field(); ?>
             ...
             <div  > <label> Name of Cake </label>
                 ...
                 <img hight=150px; width=150px; src="menuimage/<?php echo e($data->image); ?>" > </div>
...
</html><?php /**PATH E:\totorial\cake\resources\views/admin/update_menu.blade.php ENDPATH**/ ?>